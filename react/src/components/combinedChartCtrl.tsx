// Converted from src/app/pages/charts/amCharts/combinedChart/combinedChartCtrl.js
...
const CombinedChartCtrl: React.FC<{ id: string }> = ({ id }) => {
  useEffect(() => {
      ...
      valueAxes: [
        {
          ...
          position: 'left',
          autoGridCount: false,
          labelFunction: (value: number) => `$${Math.round(value)}M`,
        },
        {
          color: layoutColors.defaultText,
          axisColor: layoutColors.defaultText,
...
export default CombinedChartCtrl;
