// Converted from src/app/pages/ui/icons/IconsPageCtrl.js
...
interface RoundedIcon extends Icon {
  color: string;
}

interface Icons {
  kameleonIcons: Icon[];
  kameleonRoundedIcons: RoundedIcon[];
  ionicons: string[];
  fontAwesomeIcons: string[];
  socicon: string[];
}

const IconsPageCtrl: React.FC = () => {
  const icons: Icons = {
    kameleonIcons: [
