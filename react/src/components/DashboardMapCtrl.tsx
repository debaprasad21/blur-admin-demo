// Converted from src/app/pages/dashboard/dashboardMap/DashboardMapCtrl.js
...
const DashboardMapCtrl: React.FC = () => {
  useEffect(() => {
  ...
  return <div id="amChartMap" style={{ width: '100%', height: '500px' }} />;
};

export default DashboardMapCtrl;
