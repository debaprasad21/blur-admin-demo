// Converted from src/app/pages/dashboard/dashboardLineChart/DashboardLineChartCtrl.js
...
const DashboardLineChartCtrl: React.FC = () => {
  const layoutColors = baConfig.colors;
  const graphColor = baConfig.theme.blur ? '#000000' : layoutColors.primary;
  const chartData = [
  ...
  useEffect(() => {
    const chart = AmCharts.makeChart('amchart', {
      type: 'serial',
      theme: 'blur',
      marginTop: 15,
      marginRight: 15,
  ...
  }, [layoutColors, graphColor, chartData]);

  return <div id="amchart" style={{ width: '100%', height: '500px' }} />;
};

export default DashboardLineChartCtrl;
