// Converted from src/app/pages/charts/amCharts/lineChart/LineChartCtrl.js
...
const LineChartCtrl: React.FC<{ id: string }> = ({ id }) => {
  useEffect(() => {
    const layoutColors = baConfig.colors;

    const lineChart = AmCharts.makeChart(id, {
      type: 'serial',
      theme: 'blur',
