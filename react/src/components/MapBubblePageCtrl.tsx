// Converted from src/app/pages/maps/map-bubbles/MapBubblePageCtrl.js
...
const MapBubblePageCtrl: React.FC = () => {
  const layoutColors = baConfig.colors;
  const latlong: Record<string, { latitude: number; longitude: number }> = {
  ...
  return <div id="map-bubbles" style={{ width: '100%', height: '500px' }} />;
};

export default MapBubblePageCtrl;
